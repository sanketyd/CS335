...
def main():
    ...
    def p_CompileUnit(p):
        ''' CompileUnit : PackageDeclaration ImportDeclarations TypeDeclarations
        '''
    ...
    def p_Type(p):
        '''Type : PrimType ArrSignList
            | ReferenceType ArrSignList
            '''
        non_terminals.append(tuple(p.slice))
    ...
    def p_TypeArgument(p):
        ''' TypeArgument : ReferenceType
            ...
            | QUESTION SUPER ReferenceType''' ## CONFUSION HERE
        non_terminals.append(tuple(p.slice))
...
################################################################################
    ...
    def p_ArrayInitializer(p):
        ''' ArrayInitializer : BLOCK_OPENER VariableInitializers COMMA BLOCK_CLOSER
        | BLOCK_OPENER VariableInitializers BLOCK_CLOSER
    ...
    def p_CatchType(p):
        ''' CatchType : QualifiedIdentifier
            | CatchType  BITWISE_OR QualifiedIdentifier '''
        non_terminals.append(tuple(p.slice))
    ...
    def p_Literal(p):
        ''' Literal : INT_CONSTANT
            ...
            | CHAR_CONSTANT
            | STR_CONSTANT
            | NULL ''' # TODO:.append boolean literal in lexer
        non_terminals.append(tuple(p.slice))
    ...
    def p_ArrExpressionList(p):
        ''' ArrExpressionList : ArrExpressionList L_SQBR Expression R_SQBR
            |
        '''
