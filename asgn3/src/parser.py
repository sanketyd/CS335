...
def main():
    ...
    def p_CompileUnit(p):
        ''' CompileUnit : PackageDeclaration ImportDeclarations TypeDeclaration
            ...
            | TypeDeclaration
        '''
        non_terminals.add(tuple(p.slice))
...
################################################################################
    ...
    def p_ArrayInitializer(p):
        ...
        | BLOCK_OPENER COMMA BLOCK_CLOSER
    ...
    def p_BlockStatements(p):
        ''' BlockStatements : BlockStatement
            | BlockStatements BlockStatement '''
        # TODO: epsilon transition removed. CHECK IT
        non_terminals.add(tuple(p.slice))
    ...
    def p_Expression1Rest(p):
        ''' Expression1Rest : QUESTION Expression COLON Expression1 ''' #should add QUESTION before Expression
        non_terminals.add(tuple(p.slice))
    ...
    def p_Literal(p):
        ''' Literal : INT_CONSTANT
            ...
            | CHAR_CONSTANT
            | STR_CONSTANT
            | NULL ''' # TODO: Add boolean literal in lexer
        non_terminals.add(tuple(p.slice))
